	...
	<div class="container" id="QR-Code">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <div class="navbar-form navbar-left">
                        <h4>Upload QR Code Image to Scan</h4>
                    </div>
				</div>
				...
				<form name="myform" action="storeData.php" method="POST">
					<input type="text" name="hidden1" id="hidden1" />
					<input name="submit" id="submit" value="Submit Data to DataBase" type="submit" />
				</form>
				</div>
				</div>
		</div>   </div>   </div>   </div>
		<div class="container" id="QR-Code">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <div class="navbar-form navbar-left">
                        <h4>Web Cam Based QR Scanning facility</h4>
                    </div>
